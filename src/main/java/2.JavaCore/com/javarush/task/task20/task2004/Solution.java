...
public class Solution {
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            //printWriter.println(i); // Забыл, что переменные i и j - не статичные и не прописал this.
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            //i = Integer.parseInt(reader.readLine());// Забыл, что переменные i и j - не статичные и не прописал this.
